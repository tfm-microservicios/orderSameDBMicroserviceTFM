...
public class OrderDto {
	...
	public String toString() {
		return "OrderDto{" + "id=" + id + "\'" + ", description='" + description + '\'' + ", providerId=" + providerId
				+ ", openingDate=" + openingDate + ", closingDate=" + closingDate + ", orderLines="
				+ Arrays.toString(orderLines) + '}';
	}
}
